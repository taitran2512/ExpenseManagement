...
import { watchLoginSocialSaga } from './account/loginSocialSaga';
import { watchtransferMoneySaga } from './home/transferMoneySaga';
...
export default function* rootSaga() {
   yield all([
      ...
      watchLoginSocialSaga(),
      watchtransferMoneySaga(),
   ]);
}
