...
const expenseType = [
   ...
   { code: 'gym', title: 'Gym', icon: Images.ic_gym },
   { code: 'hair', title: 'Cắt tóc', icon: Images.ic_hair },
   { code: 'tooth', title: 'Khám răng', icon: Images.ic_tooth },
   ...
   { code: 'helmet', title: 'Xe máy', icon: Images.ic_helmet },
