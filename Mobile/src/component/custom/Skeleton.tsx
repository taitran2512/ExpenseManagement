...
interface SkeletonPlaceholderProps {
   ...
   /**
    * Determines the animation speed in milliseconds. By default is 1000
    */
   speed?: number;
}
...
Skeleton.Item = ({ children, ...style }: SkeletonPlaceholderItem): JSX.Element => (
   <View style={style}>{children}</View>
);

//@ts-ignore
Skeleton.Item.displayName = 'SkeletonPlaceholderItem';
